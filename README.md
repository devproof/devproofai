...
helm install devproof oci://ghcr.io/devproof/devproofai-helm --version v0.1.0 -n devproof --create-namespace
...
helm install devproof oci://ghcr.io/devproof/devproofai-helm --version v0.1.0 -n devproof --create-namespace --set llmkube.enabled=false
