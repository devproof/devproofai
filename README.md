...
helm install devproof oci://ghcr.io/devproof/devproofai-helm --version 0.1.4 -n devproof --create-namespace
...
helm install devproof oci://ghcr.io/devproof/devproofai-helm --version 0.1.4 -n devproof --create-namespace --set llmkube.enabled=false
